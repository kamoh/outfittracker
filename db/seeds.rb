...
@flatiron_t_shirt_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@flatiron_hoodie_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@brown_polo_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@levi_jeans1_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@levi_jeans2_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@levi_jeans3_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@blue_button_down_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@linen_pants_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
@blue_shorts_pic = File.open(File.join(Rails.root, '/public/test/FILENAME'))
